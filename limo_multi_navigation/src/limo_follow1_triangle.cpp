...
void followLeader()
{
    ...
    try
    {
        listener.waitForTransform("/limo2", "/limo1", ros::Time(0), ros::Duration(1.0));
        listener.lookupTransform("/limo2", "/limo1", ros::Time(0), transform);
    }
...
int main(int argc, char **argv)
{
    ...
    ros::Subscriber laser_sub = nh.subscribe("/limo2/scan", 10, laserCallBack);
